...
export default function How() {
  ...
  return (
    <Main pageTitle='Learn'>
      <div className="pt-[48px] px-[20px] max-w-[750px] mx-auto">
        <div
